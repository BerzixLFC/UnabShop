...
fun RegisterScreen(navController: NavController, onSuccessfulRegister: () -> Unit) {
    ...
    var passConfirmationError by remember { mutableStateOf("") }
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                shape = RoundedCornerShape(12.dp),
                supportingText = {
                    if (passConfirmationError.isNotEmpty()) {
                        Text(
                            text = passConfirmationError,
                            color = Color.Red
                        )
                    }
                }
            ...
            Button(
                onClick = {
                    ...
                    passConfirmationError = ValidateConfirmPassword(inputPassword, inputPasswordConfirmation).second
